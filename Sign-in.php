      ...
      <div class="container">
        ...
        <div class="contact_section_inner">
          ...
          <div class="contact_main">
            ...
            <h1 class="contact_text">Sign In Here!</h1>

            </div>

    
    <nav id="center">
        <form action="Sign-in-confirm.php" method="post" class="xlarge">

            <p class = "m-5" style="color:black;">Username: <input type="text" name="username" id="username"></p>
            <p class = "m-5" style="color:black;">Password: <input type="password" name="password" id="password"></p>
            <input type="submit">
        </form>            
    </nav>
    <p id="center" class="xlarge" style="color:black;">
        Not a member? <a href="sign_up.php" >Click Here to Sign Up Now!</a>
    </p>
			    ...
			    <div class="col-md-12">
			    	...
			    	<div class="useful_main border_right0">
			    		...
			    		<ul >
			    			...
			    			<li><a href="https://madisonfoodies.000webhostapp.com/sign-up.php">Sign Up</a></li>
